...
```{r echo=FALSE, fig.cap = '<a href="https://bookdown.org/daniel_dauber_io/r4np_book/the-rstudio-interface.html" style="color:Black;">RStudio interface</a>; <a href= "https://socviz.co/gettingstarted.html" style="color:Black;">RMarkdown</a>'}
knitr::include_url("https://socviz.co/gettingstarted.html")
```
...
|                                                                                                |                              |
| <a href="https://r-intro-tuebingen.netlify.app/slides/intro/intro-r">`r fa("link", fill = "#cc0033")` | r-intro-tuebingen.netlify.app             |